...
public class SearchChoiceRequest implements java.io.Serializable, EntityMapper<ChoiceEntity> {

    public SearchChoiceRequest() {
    }

    public SearchChoiceRequest(Long id) {
        this.id = id;
    }
    ...
    public SearchChoiceRequest withId(Long id) {
        setId(id);
        return this;
    }
    ...
    public SearchChoiceRequest withWeight(Double weight) {
        setWeight(weight);
        return this;
    }
    ...
    public SearchChoiceRequest withHeader(String header) {
        setHeader(header);
        return this;
    }
    ...
    public SearchChoiceRequest withBody(String body) {
        setBody(body);
        return this;
    }
    ...
    public SearchChoiceRequest withImage(Byte[] image) {
        setImage(image);
        return this;
    }
    ...
    public SearchChoiceRequest withDocument(Byte[] document) {
    ...
    public SearchChoiceRequest withExplanation(String explanation) {
    ...
    public SearchChoiceRequest withQuestion(Long question) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SearchChoiceRequest)) return false;
        SearchChoiceRequest choiceDTO = (SearchChoiceRequest) o;
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("SearchChoiceRequest{");
